...
public class StringUtils {
  ...
  public static String[] splitKeyValue(String aLine) throws ParseException {
    ...
    if (line == null) {
      ...
      if (split.length != 2) {
        ...
        if (split.length != 2) {
          msg =
              "Unable to determine Key/Value pair from line ["
                  + line
      ...
      if (split[0] == null) {
        ...
        msg =
            "No corresponding value could be found in line ["
                + line
                + "] for key ["
                + split[0]
                + "]";
  ...
  public static String[] split(
      String line, char delimiter, char beginQuoteChar, char endQuoteChar) {
