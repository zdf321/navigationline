...
@Getter
@AllArgsConstructor
public enum AuthUserGenderEnum {
    /**
     * MALE/FAMALE为正常值，通过{@link AuthUserGenderEnum#getRealGender(String)}方法获取真实的性别
     ...
     * @return 用户性别
     */
    public static AuthUserGenderEnum getRealGender(String originalGender) {
     ...
     * @since 1.13.2
     */
    public static AuthUserGenderEnum getWechatRealGender(String originalGender) {
        if (StringUtils.isEmpty(originalGender) || "0".equals(originalGender)) {
            return AuthUserGenderEnum.UNKNOWN;
        }
